...
namespace Blog.Data.Repositories.Concretes
{
    ...
    public class ArticleService : IArticleService
    {
        ...
        {
            pageSize = pageSize > 20 ? 20 : pageSize;
            var articles = await unitOfWork.GetRepository<Article>().GetAllAsync(a => !a.IsDeleted && (a.Title.Contains(keyword)||
            a.Content.Contains(keyword)) ||a.Category.Name.Contains(keyword), a => a.Category, i => i.Image, u => u.User);
